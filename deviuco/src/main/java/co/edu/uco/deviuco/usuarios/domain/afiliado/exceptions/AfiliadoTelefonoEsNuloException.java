...
public class AfiliadoTelefonoEsNuloException extends RuleDeviUcoException {
	 ...
	 private static final long serialVersionUID = 1L;
	    ...
	    public static final AfiliadoTelefonoEsNuloException create(MessageCatalog messageCatalog) {
	        var userMessage = messageCatalog.getMessageOrDefault("AfiliadoTelefonoEsNuloException");
