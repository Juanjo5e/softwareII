...
public class TipoUbicacionIdIsNullException extends RuleDeviUcoException {
    ...
    public static final TipoUbicacionIdIsNullException create(MessageCatalog messageCatalog) {
        var userMessage = messageCatalog.getMessageOrDefault("TipoUbicacionIdIsNullException");
