...
public class AfiliadoCorreoFormatoIncorrectoException extends RuleDeviUcoException {
    ...
    public static final AfiliadoCorreoFormatoIncorrectoException create(MessageCatalog messageCatalog) {
        var userMessage = messageCatalog.getMessageOrDefault("AfiliadoCorreoFormatoIncorrectoException");
